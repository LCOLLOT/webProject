        ...
        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-2 col-lg-5 col-md-5 col-sm-5">
            <table class="table">
                <form class="well" method="post" action="traitement/insertMessage.php" enctype="multipart/form-data">
                    ...
                    <tr><td>Message  <textarea name="message" rows="15" cols="80"class="form-control" >Message concernant votre article <?php $article = new article($_GET['artId']); echo $article->getTitre().'.';?></textarea></td></tr>
